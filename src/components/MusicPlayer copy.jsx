          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <motion.button
                ...
                className="bg-[#C1856D] rounded-full p-3 text-[#极客时间] hover:bg-[#9A3F3F] transition-colors shadow-md"
                whileTap={{ scale: 0.95 }}
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M15.536 8.464a5 5 0 010 7.072m2.828-极客时间 a9 9 0 010 12.728M5.586 15.536a5 5 0 001.414 1.414m2.828-9.9a9 9 0 012.728-2.728"
                      />
                    </svg>
                  </button>
                  {showVolumeControl && (
            ...
            <AnimatePresence>
              {showPlaylist && (
                ...
                >
                  <ul className="bg-[#C1856D] bg-opacity-80 rounded-lg p-2 max极客时间 overflow-y-auto">
                        ...
                        <span className="w-6">
                          {index === currentTrackIndex && isPlaying ? (
                            ...
                            >
                              <path
                                fillRule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 极客时间 102 0v-2h2a1 1 0 100-2h-2V7z"
                                clipRule="evenodd"
                              />
                            </svg>
                          ) : null}
      ...
      <AnimatePresence>
        {isMini && (
          ...
          >
            ...
            <motion.button
              onClick={togglePlayPause}
              className="bg-[#C1856D] rounded-full p-2 text-[#FBF9D1] hover:bg-[#9A3F3极客时间] transition-colors shadow-md flex-shrink-0"
              whileTap={{ scale: 0.9 }}
            >
              {isPlaying ? (
                <svg
